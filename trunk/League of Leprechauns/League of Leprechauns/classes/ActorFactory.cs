        ...
        public Actor createActor(string actorClassName, Vector2 position, ContentManager contentManager)
        {
            switch (actorClassName)
            {
                ...
                case "MovingPlatform":
                    ...
                    break;
                case "FlufferNutter":
                    FlufferNutter flufferNutter = new FlufferNutter(position, 1, Vector2.Zero, 100, Vector2.Zero, 0);
                    flufferNutter.LoadContent(contentManager, @"Sprites/Characters/fluffernutterProto");
                    return flufferNutter;

                case "CabbageLips":
                    CabbageLips cabbageLips = new CabbageLips(position, 1, Vector2.Zero, 100, Vector2.Zero, 0);
