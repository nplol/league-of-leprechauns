...
namespace LoL
{
    class FireballAbility : Ability
    {
        ...
        protected override void InstanciateAbilityObject()
        {
            ...
            AbilityObject abilityObject = new AbilityObject(GetAbilityPosition(abilityTexture.Width / 6, 0 ), abilityLifeTime, abilityTexture, 8f, owner.FaceDirection, damagePoints, new Vector2(25,25));
